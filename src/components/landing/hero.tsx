...
export function Hero({ activePersona = "protection" }: HeroProps) {
  const showBoth = !activePersona || activePersona === "protection" || activePersona === "income";
  const showProtection = showBoth || activePersona === "protection";
  const showIncome = showBoth || activePersona === "income";
        ...
        <div className="text-center mb-12">
          ...
          >
            {activePersona === "protection" ? (
              ...
              "Generate substantial yields by providing Bitcoin protection to others while maintaining full custody of your assets"
            ) : (
          ...
          >
            <Link href="/home">
              <span className="relative z-10">
                {activePersona === "protection" ? "Get Protection Now" : 
                 activePersona === "income" ? "Start Earning Income" : 
